...
class MedicalApplicationController {
    ...
    private function listApplications() {
        $applications = MedicalApplication::getAllApplications();
    ...
    private function addApplication() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (MedicalApplication::addApplication($patient_id, $doctor_id, $status_id)) {
    ...
    private function updateStatus() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (MedicalApplication::updateApplicationStatus($application_id, $status_id)) {
